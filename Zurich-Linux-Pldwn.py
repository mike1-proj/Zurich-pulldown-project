#!/home/michael/PycharmProjects/Zurich-Linux-Pldwn-ver2/.venv/bin/python3.10
import json
import subprocess
...
if value != sheet_date:
    ...
    df2 = (df.loc[[4, 32, 29, 42, 48, 61, 20, 40, 21, 25], ['Fund', 'Price date', 'Bid', 'Offer']])
    # the new data frame df.loc method above has the required rows listed first followed by the headings we want
    # following the change in the fund mix in jan 2024
    ...
    # Generating workbook instance with our existing Excel file above as the target
